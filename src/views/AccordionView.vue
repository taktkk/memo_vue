...
<template>
  <AccordionMenu>
      <template slot="title">Chapter1-1</template>
      <template class="details" slot="detail">
        <h3>UI / UX</h3>
        <p>ページ遷移が必要ない。リアルタイムでのフィードバックが必要なサイトが増えてきた</p>
      </template>
    </AccordionMenu>
    <AccordionMenu>
      <template slot="title">Chapter1-2</template>
      <template class="details" slot="detail">
        <h3>jQueryとの違い</h3>
    ...
    <AccordionMenu>
      <template slot="title">Chapter1-3</template>
      <template class="details" slot="detail">
        <h3>React.jsとの違い</h3>
